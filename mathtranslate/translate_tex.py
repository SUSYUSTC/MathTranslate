...
def main(args=None, require_updated=True):
    ...
    if options.o is None:
        ...
        if input_path_ext == ".tex" and not options.overwrite:
            ...
            print(
                "If you confirm this action, please press enter, otherwise ctrl+C to cancel"
            )
            input()
    ...
    if options.compile:
        ...
        print(
            f"You can then compile it locally by running 'xelatex {output_path}' or compile it online on overleaf"
        )
